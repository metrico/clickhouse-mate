...
@Component({
    ...
    template: ` <button mat-icon-button (click)="updateRow()" style="width: 30px; height: 30px; line-height: 30px;"><mat-icon>{{params.value ? 'expand_less' : 'expand_more'}}</mat-icon></button> `,
    styles: [],
})
